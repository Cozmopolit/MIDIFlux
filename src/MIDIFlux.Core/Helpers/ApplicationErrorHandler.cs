...
namespace MIDIFlux.Core.Helpers
{
    ...
    public static class ApplicationErrorHandler
    {
        ...
        public static DialogResult ShowError<T>(string message, string title, ILogger<T> logger, Exception? exception = null, IWin32Window? parent = null)
        {
            // Log the error
            if (exception != null)
            {
        ...
        /// <summary>
        /// Displays an error message with logging (type-inferred overload)
        /// </summary>
        /// <param name="message">The error message</param>
        /// <param name="title">The title of the error dialog</param>
        /// <param name="logger">The logger to use</param>
        ...
        /// <param name="parent">Optional parent control for the message box</param>
        /// <returns>The dialog result</returns>
        public static DialogResult ShowWarning<T>(string message, string title, ILogger<T> logger, IWin32Window? parent = null)
        {
            // Log the warning
            logger.LogWarning(message);
        ...
        /// <param name="parent">Optional parent control for the message box</param>
        /// <returns>The dialog result</returns>
        public static DialogResult ShowInformation<T>(string message, string title, ILogger<T> logger, IWin32Window? parent = null)
        {
            // Log the information
            logger.LogInformation(message);
        ...
        /// <param name="parent">Optional parent control for the message box</param>
        /// <returns>The dialog result</returns>
        public static DialogResult ShowConfirmation<T>(string message, string title, ILogger<T> logger, DialogResult defaultResult = DialogResult.Yes, IWin32Window? parent = null)
        {
            // Log the confirmation request
            logger.LogInformation("Confirmation requested: {Message}", message);
        ...
        /// <param name="parent">Optional parent control for the message box</param>
        /// <returns>The dialog result</returns>
        public static DialogResult ShowValidationError<T>(ValidationResult validationResult, string title, ILogger<T> logger, IWin32Window? parent = null)
        {
            // Build the validation error message
            var messageBuilder = new StringBuilder();
        ...
        /// <param name="parent">Optional parent control for the message box</param>
        /// <returns>The dialog result (Yes, No, or Cancel)</returns>
        public static DialogResult ShowUnsavedChangesConfirmation<T>(string message, string title, ILogger<T> logger, IWin32Window? parent = null)
        {
            // Log the unsaved changes confirmation request
            logger.LogInformation("Unsaved changes confirmation requested: {Message}", message);
        ...
        /// <param name="parent">Optional parent control for the message box</param>
        /// <returns>True if the action executed successfully, false if an exception occurred</returns>
        public static bool RunWithUiErrorHandling<T>(Action action, ILogger<T> logger, string operationName, IWin32Window? parent = null)
        {
            try
            {
                action();
        ...
        /// <param name="source">The source of the exception (e.g., "AppDomain", "UI thread")</param>
        /// <param name="logger">The logger to use</param>
        public static void HandleCriticalException<T>(Exception? exception, string source, ILogger<T> logger)
        {
            // Get the error message
            string errorMessage = exception?.Message ?? "Unknown error";
